...
*Output* — saved to `resources/intelligence/daily-briefings/YYYY-MM-DD.md`. Committed to GitHub automatically.
...
- Output: `resources/intelligence/weekly-products/YYYY-MM-DD.md`
