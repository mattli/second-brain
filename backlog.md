...
### Infrastructure
- [ ] Investigate how to reliably inject current date/time into LLM contex. This was done on Claude desktop. Observing how often I run into the issue in claude code & telegram.
