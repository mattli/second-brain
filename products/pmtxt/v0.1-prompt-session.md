...
- Product spec: `products/pmtxt/v0.1-spec.md`
- Conversation spec: `products/pmtxt/v0.1-conversation-spec.md`
- Wireframe: `products/pmtxt/v0.1-wireframe.html`
- Output target: `products/pmtxt/v0.1-prompts.md`

---

## Prompt

I'm planning the prompt engineering work that needs to happen before I start building pmtxt's "The Interview" v0.1. The product spec is at products/pmtxt/v0.1-spec.md, the conversation-design spec is at products/pmtxt/v0.1-conversation-spec.md, and the wireframe is at products/pmtxt/v0.1-wireframe.html.
...
Before I write any UI code, I need to draft three prompt artifacts. Help me create a working document at products/pmtxt/v0.1-prompts.md that captures all three.
