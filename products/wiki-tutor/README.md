...
**V1 in progress (status as of 2026-05-11).** Features #1–6 shipped (with #5/#6 in narrow form — single Explain action, no chat). Reading-progress feature, document delete, and a persistent explanation cache layered on top. Strategic flag: the polished reading layer is starting to converge on Readwise Reader; the differentiator (#7 chat → #8 sessions → #9 artifact) is not yet built and is the next leap.
