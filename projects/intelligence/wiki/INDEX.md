...
- [LLM Knowledge Bases](concepts/llm-knowledge-bases.md) — LLM-compiled personal wikis from raw sources; the Karpathy wiki pattern; file-over-app paradigm
...
- [Business Moats in AI](concepts/business-moats-in-ai.md) — Five durable moats; two paths for software companies; token price discrimination; Anthropic growth case study ($1B→$19B ARR)
- [Knowledge Work Future](concepts/knowledge-work-future.md) — AI commoditizing knowledge; wisdom skills; knowledge types taxonomy (explicit, implicit, tacit); Polanyi's epistemology
...
- [Claude Code Skill Frameworks](tools/claude-code-skill-frameworks.md) — gstack, Superpowers, Compound Engineering; domain-specific skill libraries (marketing, career, Obsidian)
...
- [AI Startup Distribution](landscape/ai-startup-distribution.md) — Distribution strategies for vibe-coded startups; cold email, X launches, MCP servers, performance marketing
...
- [Vertical AI](landscape/vertical-ai.md) — Enterprise AI adoption data; Harvey's $0→$200M ARR playbook; legal, healthcare, coding as leading sectors

## People

- [Andrej Karpathy](people/andrej-karpathy.md) — AI researcher; LLM wikis, file-over-app, agent proficiency, autoresearch; "decade of agents"; "ghosts not animals"
