...
Both authors locate AI's biggest civilizational effect not in what AI does but in what AI *changes about the conditions for being human together.* Kingsbury's collapse degrades shared reality; Diamandis's forks degrade shared humanity. The labor/safety conversation argues over which humans get to keep their jobs; these frames argue over whether the category "human" itself survives the next 30 years as a coherent thing.

Labor and safety implications from Kingsbury are synthesized elsewhere in the wiki — see [Knowledge Work Future](knowledge-work-future.md) and [AI Safety & Interpretability](../models-safety/ai-safety-interpretability.md). This page collects what doesn't fit those frames.
...
- [Humanity Is About to Fork](https://www.diamandis.com/blog/humanity-is-about-to-fork) (article, Peter Diamandis, saved 2026-04-19) — five speciation forks framework
