...
- **2026-08-12:** Added Kristen Lowe's three founder storytelling archetypes (Problem/Insight/Vision) to [Founder-Led Communications](#founder-led-communications) — archetype-specific voice, messaging pillars, channels, and common mistakes.
...
The channel sections below cover *where* to distribute — but the prior question is *what to say*. Kristen Lowe argues that founder-led communication is now "one of the lowest-cost, highest-leverage tools at your disposal to get people's attention" [[source]](https://www.lennysnewsletter.com/p/how-to-make-people-care-about-your). The anchor is a single question: *why did I start this company?* Whatever answer was compelling enough to rearrange your life around is compelling enough to make others care. Founder comms work because people root for humans, not entities or widgets.

Nearly every founder's "why" maps to one of three archetypes, each evoking a distinct emotional response in the audience:

**1. The Problem Founder** — started the company to solve their own problem. They *are* the customer, which gives them a singular ability to make other customers feel seen and understood. The emotional lever is *identification* ("I'm one of you"). Core comms strategy: high-repetition, vignette-style origin storytelling with scene-level detail — not "existing options weren't working for me" but "I was crying in my car during lunch." Additional pillars include product-design stories (every feature has a personal origin) and community spotlights (sharing customer stories that mirror the founder's own). Best channels: podcasts, profile pieces, organic social — anywhere the full story can be told and then clipped. Sara Blakely (Spanx), Dave Gilboa (Warby Parker), and Will Ahmed (Whoop) are templates. Common mistakes: overgeneralizing the problem into bland market-gap language, slipping into CEO persona ("competitor shortcomings" instead of personal pain), and oversharing beyond the founding story into influencer territory.

**2. The Insight Founder** — spotted a broken assumption or mispriced problem before others did. The emotional lever is *trust* ("you make me smarter"). Core comms strategy: regular, incisive thought leadership — being *helpful* matters more than being right. The founding insight should be explained frequently but not exclusively, so credibility transfers across topics. Additional pillars: predictions (high-conviction only — too many wrong calls erode trust) and engaging with other thinkers (debate, share what inspires you, comment on others' posts). Best channels: long-form essays, newsletters, and podcasts where reasoning can be shown; short-form social should distribute long-form thinking, not substitute for it. Aaron Levie (Box), Patrick Collison (Stripe), and Jason Fried (37signals) are models. Common mistakes: making people feel stupid for not seeing what you saw, publishing hot takes without showing reasoning, and never admitting uncertainty.

**3. The Vision Founder** — imagined a radically different world that doesn't yet exist and started a company to build it. The rarest archetype — many Insight founders misidentify as Vision founders by inflating their venture's scope. The emotional lever is *hope* ("I'd follow you"). Core comms strategy: not the vision itself, but systematically dismantling the assumptions that keep people attached to the status quo — "x doesn't have to be true," with fair explanations of why current logic needs revision. Additional pillars: the vision in concrete detail (let people visually locate themselves in your future, not abstract "a better way of working"), and milestones that prove the vision is achievable. Best channels: video and audio — conviction requires persuasive firepower (tone, cadence, body language) that text struggles to convey. Keynotes, TED-style stages, long-form video. Steve Jobs (Apple), Melanie Perkins (Canva), and Yvon Chouinard (Patagonia) are benchmarks. Common mistakes: contempt for the status quo, making yourself the protagonist instead of the future, and talking about scale ("so much disruption") instead of shape (what specifically will be different).

Each archetype has distinct success signals: Problem founders see customers sharing their own experiences in replies; Insight founders see their language recycled by others; Vision founders hear people describing their world back to them in their own words. Regardless of archetype, consistency beats optimization — committing to any channel and cadence that works beats agonizing over the perfect one, and everything else (audience segmentation, attribution, media mix) is secondary until you have a substantial body of content to optimize around.

The framework connects directly to [content-fed outbound](#gtm-as-the-mvp): a prospect who has seen founder content 3+ times converts at 2–3x the rate of a cold contact. The archetype determines *what* that content should be; the channel sections below determine *where* it goes.
...
- "How to make people care about your startup" — Kristen Lowe / [Lenny Rachitsky](../people/lenny-rachitsky.md) (Lenny's Newsletter, 2026) ([link](https://www.lennysnewsletter.com/p/how-to-make-people-care-about-your)) — Three founder storytelling archetypes (Problem/Insight/Vision): archetype-specific comms strategies, messaging pillars, channel selection, success signals, and common mistakes
