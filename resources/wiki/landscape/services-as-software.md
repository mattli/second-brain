...
> This case study now lives on [Solo Business § The Solo Operator Ceiling](solo-business.md#the-solo-operator-ceiling), alongside Ronin's other solo-operator frameworks.

Ronin runs a $40k MRR AI automation agency alone, keeping 90%+ margins by confining human effort to intake and QA while a tiered model stack (cheap workhorse → frontier → local) handles production. It's a concrete instance of the autopilot thesis above: the operator absorbs the full delivery pipeline a staffed agency would need people for, and QA capacity — not client acquisition — becomes the eventual ceiling.
