...
> TLDR: CEO of Anthropic and one of the most prominent voices on both AI's transformative potential and its existential risks — known for three major essays ("Machines of Loving Grace," "The Adolescence of Technology," and "Policy on the AI Exponential") that lay out his worldview on AI's promise, dangers, and the policy response required.
...
**2. Macroeconomics and job displacement.** Argues AI may break the historical pattern where new technologies create as many jobs as they displace — because AI broadly replicates human cognition and moves faster than labor markets can adapt. Proposes a layered response: measurement/tracking first, then pro-employment incentives (wage insurance, retention tax credits), and potentially UBI financed through taxes on AI companies if displacement proves enduring. Emphasizes that meaning and purpose matter more than income alone, but policy can buy time. See [Knowledge Work Future](../concepts/knowledge-work-future.md).
...
- [Claude Mythos](../models-safety/claude-mythos.md) — The latest model Amodei's team built; catalyzed the "Policy on the AI Exponential" essay
- [AI Regulation](../landscape/ai-regulation.md) — Broader regulatory landscape Amodei's proposals operate within
- [Knowledge Work Future](../concepts/knowledge-work-future.md) — AI's impact on labor markets, which the "Policy" essay addresses directly
- [AI Drug Discovery](../science/ai-drug-discovery.md) — Biomedical acceleration Amodei argues FDA reform should unlock
...
- "Policy on the AI Exponential" — Dario Amodei (darioamodei.com, Jun 2026) ([link](https://darioamodei.com/post/policy-on-the-ai-exponential)). Five-domain policy framework: FAA-style AI regulation, job displacement response, FDA reform for AI-accelerated science, civil liberties protections, democratic geopolitical coalition.
