...
1. **Context and state** — stateful context across turns, compaction mechanism and its lossiness, subagent strategies against [context rot](agentic-engineering.md#context-engineering-the-unifying-layer-karpathycherny), parallelization support
